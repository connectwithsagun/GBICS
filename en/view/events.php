...
<div class="container-fluid about mb-5">
    ...
    foreach ($events as $result) {?>
                    <li><i class="fa fa-angle-right"></i> <a href="?p=eventDetails&id=<?php echo $result['id']; ?>"><?php $t = $result['title'];
    ...
    foreach ($news as $r) {?>
                        <li><i class="fa fa-angle-right"></i> <a href="?p=newsDetails&id=<?php echo $r['id']; ?>"><?php $t = $r['title'];
        echo implode(' ', array_slice(explode(' ', $t), 0, 10));?></a>
                        </li>
    ...
    foreach ($notice as $re) {?>
                        <li><i class="fa fa-angle-right"></i> <a href="?p=noticeDetails&id=<?php echo $re['id']; ?>"><?php $t = $re['title'];
        echo implode(' ', array_slice(explode(' ', $t), 0, 10));?></a>
                        </li>
