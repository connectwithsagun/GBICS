...
function getEvents()
{
    $conxn = db_connect();
    $events = array();
    $sql = "SELECT * FROM tbl_events WHERE status='1' limit 5";
...
}function getNews()
{
    $conxn = db_connect();
    $news = array();
    $sql = "SELECT * FROM tbl_news WHERE status='1' limit 5";
...
function getNotice()
{
    $conxn = db_connect();
    $notice = array();
    $sql = "SELECT * FROM tbl_notice WHERE status='1' limit 5";
...
function getRecentEvents()
{
    $conxn = db_connect();
    $recentEvent = array();
    $sql = "SELECT * FROM tbl_events WHERE status='1' ORDER BY id Desc Limit 3";
    $result = mysqli_query($conxn, $sql) or die(mysqli_error($conxn));
    mysqli_close($conxn);
    if ($result->num_rows > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
