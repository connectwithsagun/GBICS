...
<form action="<?php echo $base_url . '?p=home&a=editNotices&id=' . $result['id']; ?>" method="POST" class="user">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control form-control-user" name="noticeTitle" value="<?php echo $result['title']; ?>">
        </div>
    </div>
    <div class="form-group row"> 
        <label for="description1" class="col-sm-2 col-form-label">Notice Description</label>
        <div class="col-sm-10">
            <textarea class="form-control" name="noticedesc" id="exampleFormControlTextarea3" rows="7"
